...
export class AuthenticationControllers {
    static async register(req: Request, res: Response) {
        ...
        const user = await AppDataSource.getRepository(UserModel).findOneBy({ email })
        if (user) {
        ...
        try {
            ...
            return res.send({ success: true, message: "User created successfully, please confirm your email to proceed", })
        } catch (error: any) {
    ...
    static async confirmEmail(req: Request, res: Response) {
        ...
        try {
            const user = await AppDataSource.getRepository(UserModel).findOneBy({ id })
            if (!user) {
    ...
    static async verifyOtp(req: Request, res: Response) {
        ...
        try {
            ...
            return res.send({ success: true, message: "OTP verified", bearerToken: payload })
        } catch (error: any) {
            console.log(error.message);
    ...
    static async login(req: Request, res: Response) {
        ...
        try {
            ...
            const payload = await Jwt.encode({ id: user.id, email: user.email });
            return res.send({ success: true, message: "Login successful", bearerToken: payload })
        } catch (error: any) {
            console.log(error.message);
            return res.send(ServerError())
        }
